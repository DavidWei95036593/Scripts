...
#Multiplayer troops
  ...
  ["austrian_infantry_rifle_horn","Jaeger Battalion 2","Hornist",tf_guarantee_all,0,0,fac_austrian_ranks,
   ...
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,50,5),knows_common|knows_ironflesh_2|knows_power_strike_1|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
   ["Nico's_infantry","124th","nice_Rommel",tf_guarantee_all,0,0,fac_austria,
    [itm_austrian_infantry,itm_rus_opol_hat_ranker,itm_aus_infantry_ranker,itm_austrian_infantry_pants,itm_bullets,itm_austrian_musket],
    def_attrib_multiplayer|level(20),wpex(50,5,130,5,650,5),knows_common|knows_riding_6|knows_ironflesh_3|knows_power_strike_3|knows_athletics_9,swadian_face_middle_1, swadian_face_old_2],
